...
const en: Dict = {
  ...
  compareColors: {
    title: "Compare with previous colour",
    prev: "Previous",
    current: "Current",
    value: "value",
    valueStep: "Value step",
    empty: "Pick another colour to compare it with your last pick.",
    howTo: "To get from the previous colour to this one:",
    same: "Same colour — no change needed.",
    darker: "{n} steps darker",
    lighter: "{n} steps lighter",
    sameValue: "same value",
    adjust: "Or nudge the previous mix: add ~{percent}% {name}.",
    pin: "Pin (keep in memory)",
    unpin: "Unpin",
    remove: "Remove",
    setPrev: "Compare against",
    clear: "Clear recent",
    footer: "Estimate — your mix's tinting strength is assumed average.",
  },
  manual: {
...
const es: Dict = {
  ...
  compareColors: {
    title: "Comparar con el color anterior",
    prev: "Anterior",
    current: "Actual",
    value: "valor",
    valueStep: "Salto de valor",
    empty: "Elegí otro color para compararlo con el último que pickeaste.",
    howTo: "Para pasar del color anterior a este:",
    same: "Mismo color — no hace falta cambiar nada.",
    darker: "{n} más oscuro",
    lighter: "{n} más claro",
    sameValue: "mismo valor",
    adjust: "O ajustá la mezcla anterior: agregá ~{percent}% de {name}.",
    pin: "Fijar (mantener en memoria)",
    unpin: "Dejar de fijar",
    remove: "Quitar",
    setPrev: "Comparar contra",
    clear: "Limpiar recientes",
    footer: "Estimación — se asume una fuerza tintórea media de tu mezcla.",
  },
  manual: {
